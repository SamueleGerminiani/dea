...
errCluster="../simulator/err/errSR_cluster.csv"
errClusterRandom="../simulator/err/errSR_cluster_random.csv"
...
if [ "$1" = -p ]; then
    ...
    echo "x,size,errCluster,errClusterRandom" >> "plotClusterSR.csv"
    for ((k=0;k<i;k++)); do
