...
module AESL_automem_layer7_out (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = {`STRINGIFY(`TV_PATH),"/cdatafile/c.myproject.autotvin_layer7_out.dat"}, 
    TV_OUT = {`STRINGIFY(`TV_PATH),"/rtldatafile/rtl.myproject.autotvout_layer7_out.dat"}; 
//------------------------Local signal-------------------
