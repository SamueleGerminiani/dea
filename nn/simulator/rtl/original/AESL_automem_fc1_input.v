...
//------------------------Parameter----------------------
localparam
    TV_IN  = {`STRINGIFY(`TV_PATH),"/cdatafile/c.myproject.autotvin_fc1_input.dat"}, 
    TV_OUT = {`STRINGIFY(`TV_PATH),"/rtldatafile/rtl.myproject.autotvout_fc1_input.dat"}; 
//------------------------Local signal-------------------
